...
public class CEBASI18N {
    ...
    public String getMessage(String id, String[] args) {
        return this.messageSource.getMessage(id, (Object[])args, new Locale(this.locale));
    }

    public String getEnglishMessage(String id, String[] args) {
        return this.messageSource.getMessage(id, (Object[])args, new Locale("en"));
    }

    public String getMessage(String id) {
        return this.messageSource.getMessage(id, null, new Locale(this.locale));
    }

    public String getEnglishMessage(String id) {
        return this.messageSource.getMessage(id, null, new Locale("en"));
    }

    public String getMessage(String id, String[] params, String customLocale) {
        return this.messageSource.getMessage(id, (Object[])params, new Locale(customLocale));
    }
